 ...
 * @author Vitor
 */
public class TelaInicialAdm_gerenciaruser extends javax.swing.JFrame {

    /**
     * Creates new form Login
     */
    public TelaInicialAdm_gerenciaruser() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaInicialAdm_gerenciaruser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaInicialAdm_gerenciaruser().setVisible(true);
            }
        });
    }
