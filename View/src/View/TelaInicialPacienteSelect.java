 ...
 * @author Vitor
 */
public class TelaInicialPacienteSelect extends javax.swing.JFrame {

    /**
     * Creates new form Login
     */
    public TelaInicialPacienteSelect() {
        initComponents();
    }
    ...
    private void btn_NovoPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_NovoPacienteActionPerformed
        TelaInicialNovoPaciente telaNovoPaciente = new TelaInicialNovoPaciente();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaInicialPacienteSelect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaInicialPacienteSelect().setVisible(true);
            }
        });
    }
